"""Manufacturing Defect Classifier - entrypoint (reference solution through Step 1)."""
...
def main() -> None:
    ...
    print(f"Prepared feature matrix: {X_train.shape}, test matrix: {X_test.shape}")

    # TODO (Step 2): build_pipeline(numeric_features, categorical_features) and
