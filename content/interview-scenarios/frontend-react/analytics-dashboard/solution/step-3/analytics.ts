...
// Unchanged from Step 2: Step 3's fix is entirely in the memoization
// dependency list in Dashboard.tsx, not in this data layer. Events are kept
// when they're at or after the range's cutoff AND their type is selected.
